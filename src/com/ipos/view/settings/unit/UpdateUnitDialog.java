 ...
 * @author megeh
 */
public class UpdateUnitDialog extends javax.swing.JDialog {
     ...
     * @param u
     */
    public UpdateUnitDialog(java.awt.Frame parent, boolean modal, EntityManagerFactory emf, Unit u) {
        super(parent, modal);
        initComponents();
        initElements(emf, u);
    }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Unit successfully updated.", "Sucess", JOptionPane.INFORMATION_MESSAGE);

            hideThis();
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, "Error, unit not updated.", "Failed", JOptionPane.ERROR_MESSAGE);

            Logger.getLogger(UpdateUnitDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initElements(EntityManagerFactory emf, Unit u) {
        controller = new UnitJpaController(emf);
        unit = u;

        // Set entity to be updated.
        codeTextField.setText(unit.getCode());
