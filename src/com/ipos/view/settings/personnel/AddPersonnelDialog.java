...
public class AddPersonnelDialog extends javax.swing.JDialog {
     ...
     * @param emf
     */
    public AddPersonnelDialog(java.awt.Frame parent, boolean modal, EntityManagerFactory emf) {
        super(parent, modal);
        initComponents();
        initElements(emf);
    }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Personnel successfully saved.", "Sucess", JOptionPane.INFORMATION_MESSAGE);

            hideThis();
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, "Error, personnel not saved.", "Failed", JOptionPane.ERROR_MESSAGE);

            Logger.getLogger(AddPersonnelDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
